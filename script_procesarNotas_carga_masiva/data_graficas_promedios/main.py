import pandas as pd
from data_media import procesar_data_media
...
resultado11 = procesar_data_media("../../Datos_base/periodos/Sabana_de_notas_descriptiva_11.xlsx")
...
df_data_concatenado = pd.concat([
    resultado11,
    # resultado10,resultado9,resultado8,resultado7,resultado6,
...
# Exportar a Excel
ruta_salida = "./data_graficas_2026.xlsx"
...
with open('consolidado_data_graficas_2026.json', 'w', encoding='utf-8') as json_file:
